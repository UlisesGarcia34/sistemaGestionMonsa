# CLAUDE.md — Sistema de gestion de Monsa Global Cargo (MGC)
...
internet en un flujo que hoy es local, CLAUDE.md seccion 7):
...
(El `backend/.env` actual apunta a `mysql://root:root@localhost:3306/monsa_gestion`.)
...
| ------------------------------- | ---------------- | -------------- |
| `admin@monsaglobalcargo.com`    | ADMIN            | `admin123`     |
| `karen@monsaglobalcargo.com`    | VENTAS           | `password123`  |
| `araceli@monsaglobalcargo.com`  | CUSTOMER_SERVICE | `password123`  |
...
- **Contrasenas de desarrollo**: `admin123` (constante `PASSWORD_ADMIN`) y `password123`
...
- **Base de datos: MySQL 8 local**, `mysql://root:root@localhost:3306/monsa_gestion`.
